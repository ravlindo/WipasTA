                ...
                <div class="brand-slider owl-carousel owl-theme">
                    <div class="brand-item">
                        <a href="index.html">
                            ...
                            <img src="{{ asset("template/assets/img/brand/brand-logo1.png") }}" class="brand-logo-two" alt="Images">
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="index.html">
                            <img src="{{ asset("template/assets/img/brand/2.png") }}" class="brand-logo-one" alt="Images">
                            <img src="{{ asset("template/assets/img/brand/brand-logo2.png") }}" class="brand-logo-two" alt="Images">
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="index.html">
                            <img src="{{ asset("template/assets/img/brand/3.png") }}" class="brand-logo-one" alt="Images">
                            <img src="{{ asset("template/assets/img/brand/brand-logo3.png") }}" class="brand-logo-two" alt="Images">
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="index.html">
                            <img src="{{ asset("template/assets/img/brand/4.png") }}" class="brand-logo-one" alt="Images">
                            <img src="{{ asset("template/assets/img/brand/brand-logo4.png") }}" class="brand-logo-two" alt="Images">
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="index.html">
                            <img src="{{ asset("template/assets/img/brand/5.png") }}" class="brand-logo-one" alt="Images">
                            <img src="{{ asset("template/assets/img/brand/brand-logo5.png") }}" class="brand-logo-two" alt="Images">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-text">
                            <div class="section-title">
                                ...
                                <p>
                                    The introduced now, the they expect, animals the desk, and catch temple. More seven my couldn't
                                    it the character using recommended. Fees, more the them. Saw and deep classes create it brief.
                                </p>
                            </div>
                    ...
                    <div class="col-lg-7 col-xxl-6">
                        <div class="course-item">
                            <div class="course-text">
                                ...
                                <p>
                                    Attempt. Origin it the get and the been came into the fitted would another behind think insur is ance sister hell
                                    mild, back least on war, can of, remote become into and and that the that as a  me skyline was first him many instruments,
                                    nearby a to he purpose series helplessly didn't has a long question tricoloured half here, the links needed in considerable.
                                </p>
                                <p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-item">
                                <a href="{{ asset("template/assets/img/gallery/1.jpg") }}">
                                    <img src="{{ asset("template/assets/img/gallery/1.jpg") }}" alt="Gallery Images">
                                </a>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-item">
                                <a href="{{ asset("template/assets/img/gallery/2.jpg") }}">
                                    <img src="{{ asset("template/assets/img/gallery/2.jpg") }}" alt="Gallery Images">
                                </a>
                                <div class="gallery-text">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-item">
                                <a href="{{ asset("template/assets/img/gallery/3.jpg") }}">
                                    <img src="{{ asset("template/assets/img/gallery/3.jpg") }}" alt="Gallery Images">
                                </a>
                                <div class="gallery-text">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-item">
                                <a href="{{ asset("template/assets/img/gallery/4.jpg") }}">
                                    <img src="{{ asset("template/assets/img/gallery/4.jpg") }}" alt="Gallery Images">
                                </a>
                                <div class="gallery-text">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-item">
                                <a href="{{ asset("template/assets/img/gallery/5.jpg") }}">
                                    <img src="{{ asset("template/assets/img/gallery/5.jpg") }}" alt="Gallery Images">
                                </a>
                                <div class="gallery-text">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-item">
                                <a href="{{ asset("template/assets/img/gallery/6.jpg") }}">
                                    <img src="{{ asset("template/assets/img/gallery/6.jpg") }}" alt="Gallery Images">
                                </a>
                                <div class="gallery-text">
